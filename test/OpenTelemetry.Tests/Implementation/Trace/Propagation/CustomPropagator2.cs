// <copyright file="CustomPropagator2.cs" company="OpenTelemetry Authors">
...
{
    public class CustomPropagator2 : ITextFormat
    {
        ...
        {
            setter(carrier, "custom-tag", "custom-propagator-2");
            return;
        }
